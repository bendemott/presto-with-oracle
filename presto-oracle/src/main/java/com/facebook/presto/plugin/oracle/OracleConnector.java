...
{
    private static final Logger log = Logger.get(OracleConnector.class);

    private final LifeCycleManager lifeCycleManager;
    private final JdbcMetadataFactory jdbcMetadataFactory;
    private final JdbcSplitManager jdbcSplitManager;
    private final OracleRecordSetProvider oracleRecordSetProvider;
    private final JdbcPageSinkProvider jdbcPageSinkProvider;
    private final OraclePageSourceProvider oraclePageSourceProvider;
    ...
    {
        return oraclePageSourceProvider;
    }

    @Override
    public ConnectorRecordSetProvider getRecordSetProvider()
    {
        return oracleRecordSetProvider;
    }
